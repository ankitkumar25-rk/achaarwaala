                  ...
                  {r.status === 'PENDING' && (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all bg-[#5b3f2f] text-white shadow-sm hover:bg-[#4a3427]"
                      >
                        Approve
                      </button>
                      <button
                    ...
                    <td className="px-6 py-4">
                      {r.status === 'PENDING' && (
                        <div className="flex gap-2">
                          <button 
                            onClick={() => approveMut.mutate({ id: r.id, refundAmount: r.order?.total })}
                            className="px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all bg-[#5b3f2f] text-white hover:bg-[#4a3427]"
                          >
                            Approve
                          </button>
                          <button 
